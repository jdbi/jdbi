...
public final class DefaultBackendMessageDecoderTest {
    ...
    private FirstStep<BackendMessage> decode(char discriminator, Function<ByteBuf, ByteBuf> decode) {
        ByteBuf payload = decode.apply(Unpooled.buffer());
        ...
        return DefaultBackendMessageDecoder.INSTANCE.decode(envelope)
