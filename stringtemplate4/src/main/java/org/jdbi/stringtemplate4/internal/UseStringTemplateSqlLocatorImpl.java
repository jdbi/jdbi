 ...
 */
package org.jdbi.stringtemplate4.internal;
...
import static org.jdbi.stringtemplate4.StringTemplateSqlLocator.findStringTemplateGroup;
...
public class UseStringTemplateSqlLocatorImpl extends SimpleExtensionConfigurer {
    ...
    public void configure(ConfigRegistry config, Annotation annotation, Class<?> sqlObjectType) {
        config.configure(SqlObjects.class, c -> c.sqlLocator(locator));
