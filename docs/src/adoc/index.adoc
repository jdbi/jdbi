...
* https://jdbi.org/releases/3.39.0[Release 3.39.0 - 2023-07-17^] - *This is the last release of Jdbi to support Java 8!*
...
[%header, cols="<1, <1, <1, <3", stripe=none]
|===
| Module | Source | Javadocs | Description
