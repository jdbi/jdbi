...
If you wish to roll your own version of Vavr add an exclusion for io.vavr:vavr.
Currently Vavr >= 0.9.0 is supported and tested.

As with other plugins: install via `Jdbi` instance or use auto install.
