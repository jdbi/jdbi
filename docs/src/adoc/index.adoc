...
Most applications that only _use_ Jdbi (open handles, run statements, attach SQL objects) need only two mechanical changes: the package rename, and moving configuration into the builder.
...
This is a find-and-replace across imports; no types were renamed.
