...
Jdbi 4 adds `StatementTemplate`, a handle-independent, reusable query.
It renders, parses, and snapshots configuration once, then executes against any handle without repeating that work -- useful for a hot query run many times:
