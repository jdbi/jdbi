...
<1> The SQL data source that Jdbi will connect to. In this example we use a
    Derby database, but it can be any JDBC-compatible database.
...
<bean id="jdbi" class="org.jdbi.v3.spring4.JdbiFactoryBean">
  ...
  <property name="installPlugins" value="true"/>
</bean>
----
