...
Jdbi supports two strategies for these connections: the handle joins the external transaction, or Jdbi ignores transactions completely.
...
To let Jdbi manage transactions, keep autocommit enabled and demarcate transactions with the Jdbi API.
