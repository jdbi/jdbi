...
[WARNING]
Java native is still very much under development. The current Jdbi support is only for GraalVM 25 or newer as the metadata format has changed between the last LTS (Java 21) and the current LTS (Java 25). Jdbi only supports Java 25+.
