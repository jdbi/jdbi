...
A type- or method-level customizer that touches the live statement without implementing `StatementScoped` is handed a configuration surface that does not support statement operations, and the invocation fails.
