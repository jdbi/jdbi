...
implemented feaatures. We do support both JavaBean style getters and setters as
...
of an enclosing transaction.  Storing, reading, and a delete hook are provided.
