...
Java.  *jdbi3* is the third major release which introduces enhanced support for
Java 8 concepts, countless refinements to the design and implementation, and
enhanced support for modular plugins.
