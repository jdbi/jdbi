...
===== Supported attribute annotations
...
* `@Unmappable` for `BeanMapper` bean properties and `FieldMapper` fields. Any attribute with this annotation will be ignored.
...
lombok.copyableAnnotations += org.jdbi.v3.core.annotation.Unmappable
