...
There is no guarantee that Jdbi components of different versions (e.g. `jdbi3-core` version 1.2.3 and `jdbi-sqlobject` version 1.3.1) work together.
...
| Sets the JSON implementation used to serialize and deserialize json columns. Needs to be set when using the generic Json serialization/deserialization mapper. When installing the `jdbi3-gson2`, `jdbi3-jackson2`, `jdbi3-jackson3`, or `jdbi3-moshi` plugin, this is automatically set to the provided implementation.
...
- `jdbi3-caffeine-cache` - Using the https://github.com/ben-manes/caffeine[Caffeine^] cache library.
This used to be the default cache up to version 3.36.0
- `jdbi3-noop-cache`, - Disables caching.
...
The `jdbi3-testing` artifact provides link:{jdbidocs}/testing/junit/JdbiExtension.html[JdbiExtension^] for JUnit based tests.
...
from the `jdbi3-opentelemetry` artifact will cause Jdbi statements to emit trace spans recording data similarly as JFR events above.
...
----
dependencies {
    implementation("org.jdbi:jdbi3-guava:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-jackson2:{project_version}")
}
----
...
<dependency>
    <groupId>org.jdbi</groupId>
    <artifactId>jdbi3-jackson3</artifactId>
    <version>{project_version}</version>
</dependency>
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-jackson3:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-gson2:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-moshi:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-jodatime2:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-jpa:{project_version}")
}
----
...
https://kotlinlang.org/[Kotlin^] support is provided by *jdbi3-kotlin* and *jdbi3-kotlin-sqlobject* modules.
...
The *jdbi3-kotlin* plugin adds mapping support for Kotlin data classes.
...
----
dependencies {
    implementation("org.jdbi:jdbi3-kotlin:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-kotlin-sqlobject:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-oracle12:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-postgres:{project_version}")
}
----
...
The *jdbi3-sqlite* plugin provides support for using the https://github.com/xerial/sqlite-jdbc[SQLite JDBC Driver^] with Jdbi.
...
----
dependencies {
    implementation("org.jdbi:jdbi3-sqlite:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-stringtemplate4:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-freemarker:{project_version}")
}
----
...
----
dependencies {
    implementation("org.jdbi:jdbi3-vavr:{project_version}")
}
----
...
If you include the `jdbi3-generator` artifact as an annotation processor and annotate your SqlObject definitions with `@GenerateSqlObject`, the generator will produce an implementing class and avoids using
