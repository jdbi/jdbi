...
Installing the link:{jdbidocs}/otel/JdbiOpenTelemetryPlugin.html[JdbiOpenTelemetryPlugin^] will cause Jdbi
statements to emit trace spans recording data similarly as JFR events above. Additionally, it will add the
trace id to JFR events.
