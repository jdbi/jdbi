 ...
 * &lt;/bean&gt;
 * &lt;bean id="jdbi" class="org.jdbi.spring5.JdbiFactoryBean"&gt;
 * &lt;property name="dataSource" ref="derby"/&gt;
 * &lt;/bean&gt;
 * &lt;bean id="service" class="org.jdbi.spring5.DummyService"&gt;
 * &lt;constructor-arg ref="jdbi"/&gt;
 * &lt;/bean&gt;
 * &lt;/beans&gt;
 * </pre>
 *
 * The automatic detection of {@link org.jdbi.spring5.JdbiRepository} can be enabled by using the
 * {@link org.jdbi.spring5.EnableJdbiRepositories} annotation.
 *
