 ...
 */
public class OracleDatabaseExtension extends JdbiExtension {

    private final String uri;
    private final String username;
    private final String password;

    public OracleDatabaseExtension(final OracleContainer oracleContainer) {
    ...
    public static void createTables(final OracleContainer oracleContainer) throws SQLException {
