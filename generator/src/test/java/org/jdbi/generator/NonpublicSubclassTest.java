...
public class NonpublicSubclassTest {
    ...
    public void abstractClassToString() {
        assertThat(dao.toString())
                .isEqualTo("org.jdbi.generator.AbstractClassDaoImpl@" + Integer.toHexString(System.identityHashCode(dao)));
    }
    ...
    public void interfaceToString() {
        ...
        assertThat(myDao.toString())
                .isEqualTo("org.jdbi.generator.InterfaceDaoImpl$OnDemand@" + Integer.toHexString(System.identityHashCode(myDao)));
    }
