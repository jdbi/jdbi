...
Jdbi requires Java 21 or better to run. We also test against (at least) all later LTS releases.
Further information on versioning is available in the Developer Guide.

### Compatibility with older Java versions

TODO: fill this in for v4 release
