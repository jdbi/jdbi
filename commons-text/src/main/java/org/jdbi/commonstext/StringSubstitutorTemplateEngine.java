...
/**
 * Register an instance of this class ({@link org.jdbi.core.statement.SqlStatements#setTemplateEngine}) to use an Apache Commons Text {@link StringSubstitutor} as a {@link TemplateEngine}. This lets you use any pair of strings as variable delimiters, enabling the use of syntax like <pre>select * from ${foo}</pre>, <pre>select * from &lt;foo&gt;</pre>, <pre>select * from %foo%</pre>, etc.
 */
public class StringSubstitutorTemplateEngine implements TemplateEngine {
    ...
    public String render(String template, RenderContext renderContext) {
        StringSubstitutor substitutor = new StringSubstitutor(renderContext.getAttributes());
