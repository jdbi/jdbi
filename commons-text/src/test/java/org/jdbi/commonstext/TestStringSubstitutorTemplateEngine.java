...
public class TestStringSubstitutorTemplateEngine {
    ...
    public void testDefaults() {
        ...
        assertThat(new StringSubstitutorTemplateEngine().render("create table ${name};", StatementContextAccess.renderContext(ctx)))
    ...
    public void testMissingAttribute() {
        ...
        assertThat(engine.render("select * from foo where x=<x>", StatementContextAccess.renderContext(ctx)))
    ...
    public void testCustomPrefixSuffix() {
        ...
        assertThat(engine.render("create table <name>;", StatementContextAccess.renderContext(ctx)))
            .isEqualTo("create table foo;");
    }
