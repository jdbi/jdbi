...
import org.jdbi.sqlobject.customizer.AllowUnusedBindings;
...
public class AllowUnusedBindingsFactory implements SqlStatementCustomizerFactory {
    ...
    public SqlStatementCustomizer createForType(Annotation annotation, Class<?> sqlObjectType) {
        return s -> s.getConfig(SqlStatements.class).setUnusedBindingAllowed(((AllowUnusedBindings) annotation).value());
    }
}
