...
import org.jdbi.sqlobject.customizer.internal.BindListFactory;

import static org.jdbi.core.statement.EmptyHandling.BLANK;
import static org.jdbi.core.statement.EmptyHandling.DEFINE_NULL;
import static org.jdbi.core.statement.EmptyHandling.NULL_KEYWORD;
...
public @interface BindList {
    ...
    enum EmptyHandling {
        ...
        /**
         * <p>Define {@code null}, leaving the result up to the {@link org.jdbi.core.statement.TemplateEngine} to decide.</p>
         *
         ...
         */
        THROW(org.jdbi.core.statement.EmptyHandling.THROW);

        private final org.jdbi.core.statement.EmptyHandling coreImpl;

        EmptyHandling(org.jdbi.core.statement.EmptyHandling coreImpl) {
        ...
        public org.jdbi.core.statement.EmptyHandling getCoreImpl() {
            return coreImpl;
        }
    }
}
