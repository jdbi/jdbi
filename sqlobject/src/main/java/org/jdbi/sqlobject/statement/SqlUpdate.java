 ...
 */
package org.jdbi.sqlobject.statement;
...
import org.jdbi.sqlobject.SqlObjectFactory;
import org.jdbi.sqlobject.statement.internal.SqlUpdateHandler;
...
@UseExtensionHandler(id = SqlObjectFactory.EXTENSION_ID, value = SqlUpdateHandler.class)
