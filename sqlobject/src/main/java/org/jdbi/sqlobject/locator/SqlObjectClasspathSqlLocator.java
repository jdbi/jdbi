...
/**
 * Locates SQL in {@code .sql} files on the classpath for use with {@link org.jdbi.sqlobject.statement.SqlQuery}.  Given a class and method name, for example
 ...
 *
 * @see org.jdbi.core.locator.ClasspathSqlLocator
 */
