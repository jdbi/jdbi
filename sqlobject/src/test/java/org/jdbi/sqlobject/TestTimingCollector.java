...
public class TestTimingCollector {
    ...
    public void testInsert() {
        dao.insert(1, "Brian");
        dao.insert(2, "Jeff");
        assertThat(timingCollector.statementNames).containsExactly("org.jdbi.sqlobject.DAO.insert");
    }

    @Test
    public void testInsertBatch() {
        dao.insertBatch(Arrays.asList(1, 2, 3), Arrays.asList("Mary", "David", "Kate"));
        assertThat(timingCollector.statementNames).containsOnly("org.jdbi.sqlobject.DAO.insertBatch");
    }
    ...
    public void testCustomInsert() {
        ...
        assertThat(timingCollector.statementNames).containsOnly("org.jdbi.sqlobject.DAO.customInsert");
    }
    ...
    public void testSqlQuery() {
        ...
        assertThat(timingCollector.statementNames).containsOnly(
                "org.jdbi.sqlobject.AdvancedDAO.insertBatch",
                "org.jdbi.sqlobject.AdvancedDAO.findNameById");
    }
