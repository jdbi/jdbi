...
public final class ByteCodecTest {
    ...
    public void doEncode() {
        assertThat(new ByteCodec(UnpooledByteBufAllocator.DEFAULT).doEncode((byte) 100))
            .isEqualTo(new Parameter(BINARY, INT2.getObjectId(), Unpooled.buffer().writeShort(100)));
    }

    @Test
    public void doEncodeNoValue() {
        assertThatNullPointerException().isThrownBy(() -> new ByteCodec(UnpooledByteBufAllocator.DEFAULT).doEncode(null))
