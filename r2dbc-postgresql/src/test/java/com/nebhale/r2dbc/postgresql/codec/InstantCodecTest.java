...
public final class InstantCodecTest {
    ...
    public void doEncode() {
        ...
        assertThat(new InstantCodec(UnpooledByteBufAllocator.DEFAULT).doEncode(instant))
            .isEqualTo(new Parameter(TEXT, TIMESTAMP.getObjectId(), encode(Unpooled.buffer(), instant.toString())));
    }

    @Test
    public void doEncodeNoValue() {
        assertThatNullPointerException().isThrownBy(() -> new InstantCodec(UnpooledByteBufAllocator.DEFAULT).doEncode(null))
