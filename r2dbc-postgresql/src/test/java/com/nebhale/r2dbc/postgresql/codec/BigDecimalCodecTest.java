...
public final class BigDecimalCodecTest {
    ...
    public void doEncode() {
        ...
        assertThat(new BigDecimalCodec(UnpooledByteBufAllocator.DEFAULT).doEncode(bigDecimal))
            .isEqualTo(new Parameter(TEXT, NUMERIC.getObjectId(), encode(Unpooled.buffer(), "100")));
    }

    @Test
    public void doEncodeNoValue() {
        assertThatNullPointerException().isThrownBy(() -> new BigDecimalCodec(UnpooledByteBufAllocator.DEFAULT).doEncode(null))
