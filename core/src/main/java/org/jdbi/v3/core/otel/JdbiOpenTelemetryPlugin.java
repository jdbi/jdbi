...
public class JdbiOpenTelemetryPlugin implements JdbiPlugin {
        ...
        public void contextCreated(final StatementContext ctx) {
            ...
            if (spanContext.isValid()) {
                ...
                ctx.addCleanable(() -> {
                    ...
                    span.setAttribute(BINDING, ctx.getBinding().toString(stmtConfig.getJfrParamMaxLength()));
