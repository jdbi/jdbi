...
/**
 * A row mapper which maps the fields in a statement into a constructor. The default implementation will perform a
...
public class ConstructorMapper<T> implements RowMapper<T>
{
        ...
        throws SQLException
    {
        ...
        final List<String> columnNames = new ArrayList<String>(metadata.getColumnCount());
