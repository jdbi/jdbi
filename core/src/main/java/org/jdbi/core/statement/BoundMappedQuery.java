...
public class BoundMappedQuery<T> implements QueryCustomizerMixin<BoundMappedQuery<T>> {
     ...
     * mapper resolved once by the owning {@link MappedStatementTemplate}. This is the mapped analogue of
     * {@link StatementTemplateBinding#mapTo(Class)}; the mapper is already known, so no lookup happens here.
     *
