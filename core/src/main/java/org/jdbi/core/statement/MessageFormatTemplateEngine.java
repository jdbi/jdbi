 ...
 *
 * You must use "0", "1", "2", etc as keys: start at 0, increment by 1. Keys must be numerically unique. You must {@link org.jdbi.core.config.Configurable#define(String, Object)} as many key/value pairs as there are placeholders in the pattern string.
 *
