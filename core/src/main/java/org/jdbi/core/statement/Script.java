...
import org.jdbi.core.internal.SqlScriptParser;
import org.jdbi.core.internal.SqlScriptParser.ScriptTokenHandler;
...
public class Script extends SqlStatement<Script> {
    ...
    public List<String> getStatements() {
        ...
        return splitToStatements(templateEngine.render(getSql(), RenderContext.of(getConfig())));
    }
