 ...
 */
public class StatementTemplateBinding implements ResultBearing, QueryCustomizerMixin<StatementTemplateBinding> {
     ...
     */
    @Override
    public StatementTemplateBinding attachToHandleForCleanup() {
