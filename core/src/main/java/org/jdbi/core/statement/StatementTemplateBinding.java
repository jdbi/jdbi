...
/**
 * A single, thread-confined execution of a {@link StatementTemplate} against a specific {@link Handle}.
 * Obtained from {@link StatementTemplate#with(Handle)}. Bind parameters (and optionally override defined
 ...
 */
public class StatementTemplateBinding implements ResultBearing, BindingsMixin<StatementTemplateBinding> {
    ...
    StatementTemplateBinding(final Handle handle, final StatementTemplate template) {
        this.handle = handle;
     ...
     */
    @Override
    public StatementTemplateBinding define(final String key, final Object value) {
     ...
     * @return this
     */
    public StatementTemplateBinding addCustomizer(final StatementCustomizer customizer) {
     ...
     * @return this
     */
    public StatementTemplateBinding setFetchSize(final int fetchSize) {
     ...
     * @return this
     */
    public StatementTemplateBinding setMaxRows(final int maxRows) {
     ...
     * @return this
     */
    public StatementTemplateBinding setMaxFieldSize(final int maxFieldSize) {
     ...
     * @return this
     */
    public StatementTemplateBinding setQueryTimeout(final int seconds) {
        return addCustomizer(StatementCustomizers.statementTimeout(seconds));
    }

    @Override
    @SafeVarargs
    public final <T> StatementTemplateBinding bindArray(final int pos, final T... array) {
        return BindingsMixin.super.bindArray(pos, array);
    }

    @Override
    @SafeVarargs
    public final <T> StatementTemplateBinding bindArray(final String name, final T... array) {
