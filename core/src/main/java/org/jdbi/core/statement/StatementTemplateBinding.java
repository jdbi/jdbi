 ...
 */
public class StatementTemplateBinding<R> implements BindingsMixin<StatementTemplateBinding<R>> {
    ...
    StatementTemplateBinding(final Handle handle, final StatementTemplate<R> template) {
        this.handle = handle;
     ...
     */
    @Override
    public StatementTemplateBinding<R> define(final String key, final Object value) {
    ...
    @Override
    @SafeVarargs
    public final <T> StatementTemplateBinding<R> bindArray(final int pos, final T... array) {
        return BindingsMixin.super.bindArray(pos, array);
    }

    @Override
    @SafeVarargs
    public final <T> StatementTemplateBinding<R> bindArray(final String name, final T... array) {
