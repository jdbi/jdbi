...
public interface StatementTemplateBuilder extends QueryCustomizerMixin<StatementTemplateBuilder> {
    /**
     ...
     */
    default <R> StatementTemplate<R> mapTo(final Class<R> type) {
     ...
     * @see Configurable#registerColumnMapper(ColumnMapper)
     */
    default <R> StatementTemplate<R> mapTo(final GenericType<R> type) {
        return mapTo(QualifiedType.of(type));
    }
     ...
     * @see Configurable#registerColumnMapper(ColumnMapper)
     */
    default StatementTemplate<?> mapTo(final Type type) {
        return mapTo(QualifiedType.of(type));
    }
     ...
     * @see Configurable#registerColumnMapper(ColumnMapper)
     */
    default <R> StatementTemplate<R> mapTo(final QualifiedType<R> type) {
        return new StatementTemplate<R>(this, (resultSetSupplier, ctx) -> {
     ...
     * @return a {@link ResultIterable} of the given type.
     */
    default <R> StatementTemplate<R> mapToBean(final Class<R> type) {
     ...
     */
    default StatementTemplate<Map<String, Object>> mapToMap() {
     ...
     * @see Configurable#registerColumnMapper(ColumnMapper)
     */
    default <R> StatementTemplate<Map<String, R>> mapToMap(final Class<R> valueType) {
        return new StatementTemplate<>(this, (resultSetSupplier, ctx) ->
     ...
     * @see Configurable#registerColumnMapper(ColumnMapper)
     */
    default <R> StatementTemplate<Map<String, R>> mapToMap(final GenericType<R> valueType) {
        return new StatementTemplate<>(this, (resultSetSupplier, ctx) ->
                ResultIterable.of(resultSetSupplier, GenericMapMapperFactory.getMapperForValueType(valueType, ctx.getConfig()), ctx));
    }
     ...
     */
    default <R> StatementTemplate<R> map(final ColumnMapper<R> mapper) {
     ...
     * @return a {@link ResultIterable} of type {@code <R>}.
     */
    default <R> StatementTemplate<R> map(final RowMapper<R> mapper) {
        return new StatementTemplate<>(this, (resultSetSupplier, ctx) ->
     ...
     * @return a {@link ResultIterable} of type {@code <R>}.
     */
    default <R> StatementTemplate<R> map(final RowViewMapper<R> mapper) {
