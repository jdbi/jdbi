...
import static org.jdbi.core.extension.BuiltInExtensionHandler.EQUALS_HANDLER;
import static org.jdbi.core.extension.BuiltInExtensionHandler.HASHCODE_HANDLER;
import static org.jdbi.core.extension.BuiltInExtensionHandler.NULL_HANDLER;
...
import static org.jdbi.core.internal.JdbiClassUtils.MethodKey.methodKey;
...
final class ExtensionFactoryDelegate implements ExtensionFactory {
    ...
    ExtensionFactoryDelegate(final ExtensionFactory delegatedFactory) {
    ...
    @Override
    public void buildExtensionMetadata(final ExtensionMetadata.Builder builder) {
