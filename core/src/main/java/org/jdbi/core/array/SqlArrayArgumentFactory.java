 ...
 * {@link org.jdbi.core.statement.SqlStatement#bind(int, Object)} may
 * fail to determine the array component type.  Provide explicit information with
 * {@link org.jdbi.core.statement.SqlStatement#bindByType(int, Object, org.jdbi.core.generic.GenericType)}.
 *
 * This factory is registered by default.
 * @see SqlArrayType
 * @see SqlArrayTypes
 * @see org.jdbi.core.config.Configurable#registerArrayType(SqlArrayType)
 */
