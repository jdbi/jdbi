 ...
 * @see org.jdbi.core.result.ResultBearing#map(RowMapper)
 * @see org.jdbi.core.config.Configurable#registerRowMapper(RowMapper)
 * @see org.jdbi.core.config.Configurable#registerRowMapper(java.lang.reflect.Type, RowMapper)
 */
@FunctionalInterface
public interface RowMapper<T> {
     ...
     * @throws SQLException if anything goes wrong go ahead and let this percolate; Jdbi will handle it
     * @see org.jdbi.core.mapper.reflect.BeanMapper for an example of specialization.
     */
