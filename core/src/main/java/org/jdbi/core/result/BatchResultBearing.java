...
public final class BatchResultBearing implements ResultBearing {
    ...
    /**
     * Returns the mod counts for the executed {@link org.jdbi.core.statement.PreparedBatch}
     ...
     *
     * @return the number of modified rows per batch part for the executed {@link org.jdbi.core.statement.PreparedBatch}.
     */
