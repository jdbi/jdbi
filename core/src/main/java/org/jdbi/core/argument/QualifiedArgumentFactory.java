 ...
 * to be able to log their values with an {@link org.jdbi.core.statement.SqlLogger}.
 *
...
public interface QualifiedArgumentFactory {
     ...
     *     </code> otherwise.
     * @see org.jdbi.core.statement.StatementContext#findArgumentFor(QualifiedType, Object)
