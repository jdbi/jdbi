...
/**
 * Specifies that an {@link Enum} value should be bound or mapped as its {@link Enum#name()}. This is typically default behavior.
 *
 * This annotation can be placed on the source enum (class),
 * in {@link org.jdbi.core.statement.SqlStatement#bindByType(String, Object, org.jdbi.core.qualifier.QualifiedType)} calls,
