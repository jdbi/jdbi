 ...
 */
package org.skife.jdbi.v3.unstable.oracle;

import org.skife.jdbi.v3.StatementContext;
import org.skife.jdbi.v3.exceptions.ResultSetException;
import org.skife.jdbi.v3.tweak.BaseStatementCustomizer;
...
public class OracleReturning<ResultType> extends BaseStatementCustomizer implements StatementCustomizer
{
     ...
     * {@link org.skife.jdbi.v3.BeanMapper} uses the names in the result set
     *
    ...
    /**
     * @see org.skife.jdbi.v3.tweak.StatementCustomizer#beforeExecution(java.sql.PreparedStatement,org.skife.jdbi.v3.StatementContext)
     */
    @Override
