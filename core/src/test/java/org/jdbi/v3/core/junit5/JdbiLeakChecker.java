...
final class JdbiLeakChecker implements StatementContextListener, HandleListener {
    ...
    private final ConcurrentMap<StatementContext, RecordingContext<Cleanable>> contextElements = new MapMaker().weakKeys().makeMap();
    ...
    private static final class RecordingContext<T> {
        ...
        private final ConcurrentMap<T, Boolean> objectAdded = new MapMaker().weakKeys().makeMap();
        private final ConcurrentMap<T, Boolean> objectRemoved = new MapMaker().weakKeys().makeMap();
