 ...
 * &lt;/bean&gt;
 * &lt;bean id="jdbi" class="org.jdbi.spring.JdbiFactoryBean"&gt;
 * &lt;property name="dataSource" ref="myDataSource"/&gt;
 * &lt;/bean&gt;
 * &lt;bean id="service" class="org.jdbi.spring.DummyService"&gt;
 * &lt;constructor-arg ref="jdbi"/&gt;
 * &lt;/bean&gt;
 * &lt;/beans&gt;
 * </pre>
 *
 * The automatic detection of {@link org.jdbi.spring.JdbiRepository} can be enabled by using the
 * {@link org.jdbi.spring.EnableJdbiRepositories} annotation.
 */
