...
public class JdbiUtil {
    private static final Set<Handle> UNMANAGED_HANDLES = ConcurrentHashMap.newKeySet();
    ...
    public static Handle getHandle(Jdbi jdbi) {
        ...
        if (TransactionSynchronizationManager.isSynchronizationActive()) {
            ...
            if (boundHolder == null) {
                throw new IllegalStateException("Transaction synchronization is active but no transactional resource bound (handle)");
            } else {
