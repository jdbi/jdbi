 ...
 */
package org.jdbi.v3.core.test.qualifier;
...
class SampleQualifiers {
    ...
    public static Foo foo(int value) {
        return new Foo() {
            ...
            public String toString() {
                return "@org.jdbi.v3.core.test.qualifier.SampleQualifiers.Foo(value=" + value + ")";
            }
        };
    }
    ...
    public static Bar bar(String value) {
        return new Bar() {
            ...
            @Override
            public String toString() {
                return "@org.jdbi.v3.core.test.qualifier.SampleQualifiers.Bar(value=" + value + ")";
            }
        };
    }
