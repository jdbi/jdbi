 ...
 */
package org.jdbi.v3.core.test.cache.internal;
...
import org.jdbi.v3.core.cache.internal.DefaultJdbiCache;
...
import org.jdbi.v3.core.test.cache.internal.JdbiCacheTest.TestingCacheLoader;
...
public class DefaultJdbiCacheTest {
    ...
    void testUntouchedCacheExpunge() {
        ...
        final int size = 10;
        final JdbiCache<String, String> cache = builder.maxSize(size).buildWithLoader(cacheLoader);
      ...
      keyCount++;
        ...
        for (int i = 0; i < size; i++) {
            final int creations = cacheLoader.created();
            cache.get(keys[i]);
    ...
    void testLruCacheExpunge() {
      ...
      keyCount++;
            ...
            final int cacheSize = Math.min(i + 1, size / 2);
        ...
        for (int i = 0; i < size / 2; i++) {
            ...
            final int upperKey = keys.length - 1 - i;
