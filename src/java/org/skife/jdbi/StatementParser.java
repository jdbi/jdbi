...
{
//    private static final Pattern TOKEN_PATTERN = Pattern.compile("\\s:(\\w+)");
    ...
    StatementParser(final String sql)
    {
        ...
        if (!(last_quote = quote_matcher.find()))
        {
            ...
            this.tokens = (String[]) tokens.toArray(new String[tokens.size()]);
        }
