 ...
 * @see org.skife.jdbi.v3.Query#fold(Object, Folder)
...
public interface Folder<AccumulatorType>
{
     ...
     *
     * @param accumulator The initial value passed to {@link org.skife.jdbi.v3.Query#fold(Object, Folder)}
     ...
     *         invocation will be returned from the {@link org.skife.jdbi.v3.Query#fold(Object, Folder)} call.
     * @throws SQLException will be wrapped and rethrown as a {@link org.skife.jdbi.v3.exceptions.CallbackFailedException}
     */
